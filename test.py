...
hyp = {'degrees' : 0,'translate': 0.05 * 0,'scale': 0.05 * 0,'shear': 0.641 * 0, 'hsv_h': 0.0138,'hsv_s': 0.678,'hsv_v': 0.36}
...
def test(cfg,
    ...
    if dataloader is None:
        dataset = LoadImagesAndLabels(path, imgsz, batch_size, rect=True, hyp=hyp,single_cls=False)
